...
func (s *Server) areaCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	err = s.stgs.AreaStorager.InsertArea(context.TODO(), Area)
	...
	http.Redirect(w, r, "/area/list", http.StatusSeeOther)
}
