...
func (s *Server) iterationListGet(w http.ResponseWriter, r *http.Request) {
	...
	iterations, err := s.stgs.SelectAllIterations(ctx)
	if err != nil {
	...
	possibleTeams, err := s.stgs.SelectAllTeams(ctx)
	if err != nil {
