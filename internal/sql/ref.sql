...
CREATE TABLE IF NOT EXISTS ref.Priorities(
ID INT NOT NULL GENERATED BY DEFAULT AS IDENTITY 
, LevelID int
, Name text
, ColorCode text
...
CREATE TABLE IF NOT EXISTS ref.StatusHierarchy(
  Parent int not null
, Child int not null
, PRIMARY KEY (Parent, Child)
, FOREIGN KEY (Parent) REFERENCES ref.Statuses(ID) DEFERRABLE
, FOREIGN KEY (Child) REFERENCES ref.Statuses(ID) DEFERRABLE
)  WITH (OIDS=FALSE, FILLFACTOR=90);
